 ...
 * (oculto / visível / editável) e fonte de dados por campo. Equivale à matriz
 * que o ZEEV expõe em `ConfigTaskGeneral.aspx` (`inpChkStEnabled`/`inpChkStVisible`/
 * `inpChkStManipulable`/`inpMulDsSource`).
 *
