...
const TECHNICAL_MANUAL_TITLES: Record<string, string> = {
  ...
  'operacao-tarefas-requisicoes': 'Operação de tarefas e requisições',
  'simulacao-homologacao': 'Simulação e homologação de processos',
  'consultas-relatorios': 'Consultas e visualização de relatórios',
  'criacao-relatorios': 'Criação e publicação de relatórios',
  'administracao-manuais-guide': 'Administração de manuais e Guide',
  'fontes-dados-integracoes': 'Fontes de dados e integrações',
  'documentos-assinaturas': 'Modelos de documentos e assinaturas',
  'usuarios-perfis-permissoes': 'Usuários, perfis e permissões',
  'modelos-email-notificacoes': 'Modelos de e-mail e notificações',
  'jornada-solicitante-externo': 'Jornada do solicitante externo',
  'estrutura-organizacional': 'Estrutura organizacional e distribuição de responsabilidades',
  'auditoria-rastreabilidade': 'Auditoria e rastreabilidade',
  'parametros-seguranca': 'Parâmetros, armazenamento e segurança',
  'automacao-formularios': 'Automação de formulários com JavaScript',
  'validacao-documentos': 'Validação pública de documentos',
  'categorias-catalogos': 'Categorias e organização dos catálogos',
};
...
const SECTION_TITLES: Record<string, string[]> = {
  ...
  'localizar-tarefas': ['Localizando tarefas'],
  'acompanhar-requisicoes': ['Acompanhando requisições'],
  'iniciar-simulacao': ['Iniciando uma simulação'],
  'localizar-consulta': ['Localizando uma consulta'],
  'editor-relatorios': ['Conhecendo o editor'],
  'criar-manual': ['Criando um manual'],
  'configurar-fonte': ['Configurando uma fonte'],
  'criar-modelo-documento': ['Criando um modelo'],
  'assinar-documento': ['Assinando um documento'],
  'configurar-usuarios': ['Cadastrando usuários'],
  'configurar-perfis': ['Criando um perfil de acesso'],
  'criar-modelo-email': ['Criando um modelo de e-mail'],
  'localizar-servico': ['Localizando um serviço'],
  'importar-formulario': ['Importar', 'Pré-visualizando, importando e testando'],
  'configurar-unidades': ['Configurando unidades organizacionais'],
  'configurar-posicoes': ['Cadastrando posições'],
  'consultar-organograma': ['Consultando o organograma'],
  'consultar-auditoria': ['Consultando logs de auditoria'],
  'configurar-parametros': ['Configurando parâmetros do sistema'],
  'editor-automacao': ['Conhecendo o editor de automação'],
  'validar-documento': ['Validando um documento'],
  'gerenciar-categorias': ['Gerenciando categorias'],
};
